...
export function FreehandAnnotationComponent({
    ...
    const handlePointerDown = (e: React.PointerEvent) => {
        e.stopPropagation();
        e.preventDefault();
        console.log('🖱️ [FreehandAnnotation] PointerDown - selecting annotation:', annotation.id);
        onSelect();
        onPointerDown?.(e);
    };
    ...
    const handleClick = (e: React.MouseEvent) => {
        e.stopPropagation();
        e.preventDefault();
        console.log('🖱️ [FreehandAnnotation] Click - selecting annotation:', annotation.id);
        onSelect();
    };
