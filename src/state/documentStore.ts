...
export const useDocumentStore = create<DocumentStore>()(
  immer((set, _get) => ({
    ...
    getCurrentPage: async () => {
      // PageStore에서 현재 페이지 가져오기
      const { getCurrentPage } = (await import('./stores/PageStore')).usePageStore.getState();
...
export const useCurrentPage = () => useDocumentStore((state) => state.getCurrentPage());