...
### **2.3 현재 오류 상황** ❌
- [ ] TypeScript 컴파일 오류 20개 해결
- [ ] require() 사용으로 인한 Node.js 타입 오류 해결
- [ ] 기존 컴포넌트 props 불일치 해결
- [ ] SelectionState 타입 오류 해결
